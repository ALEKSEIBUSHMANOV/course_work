...
if __name__ == '__main__':
    ...
    tokenVK = 'TOKEN VK.txt'  # токен и id доступа хранятся в файле (построчно)
    tokenYandex = 'TOKEN YANDEX.txt'  # хранится только токен яндекс диска
